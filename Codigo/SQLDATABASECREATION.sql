...
CREATE TABLE  "APLIC_IMPUTAC_PREVISION" 
   (	"ID_APLIC_IMPUTAC_PREVISION" NUMBER(6,0), 
	"SP" NUMBER(6,0) NOT NULL ENABLE, 
	"SECCIÓN" NUMBER(4,0), 
	"SERVICIO" NUMBER(4,0), 
	"PROGRAMA" VARCHAR2(5), 
	"CONCEPTO" NUMBER(10,0), 
	"PROYECTO_INVERSION" VARCHAR2(30), 
...
CREATE TABLE  "RESERVAS_CAJAFIJA" 
   (	"SECCION" VARCHAR2(4), 
	...
	"UDSGAF" VARCHAR2(15), 
	 CONSTRAINT "RESERVAS_CAJAFIJA_PK" PRIMARY KEY ("SECCION", "SERVICIO", "PROGRAMA", "CONCEPTO", "ANO") ENABLE
   )
/
...
CREATE TABLE  "PROCEDIMIENTOS_CONTRATACION" 
   (	"PROC_CONTRATACION" VARCHAR2(100), 
	"DESCRIPCION" VARCHAR2(400), 
	 CONSTRAINT "PROCEDIMIENTOS_CONTRATACION_PK" PRIMARY KEY ("PROC_CONTRATACION") ENABLE
   )
/
...
CREATE TABLE  "ORGANOS_CONTRATACION" 
   (	"ALIAS_ORGANO_CONTRATACION" VARCHAR2(30), 
...
CREATE TABLE  "SERVICIOS" 
   (	"SECCION_FK" NUMBER(4,0), 
	...
	"NOMBRE_SERVICIO" VARCHAR2(100), 
	 CONSTRAINT "SERVICIOS_PK" PRIMARY KEY ("SECCION_FK", "SERVICIO") ENABLE
   )
/
CREATE TABLE  "PROYECTOS_INVERSION" 
   (	"PROYECTO_INVERSION" VARCHAR2(40), 
	"DESCRIPCION" VARCHAR2(100) NOT NULL ENABLE, 
...
CREATE TABLE  "FACTURAS" 
   (	"ID_FACTURA" NUMBER(4,0), 
	...
	"PAGADOR" NUMBER(6,0), 
	"COMENTARIOS" VARCHAR2(1000), 
	"NUM_IMPUTACION" NUMBER(6,0) NOT NULL ENABLE, 
...
CREATE TABLE  "MODELOS" 
   (	"ID_MODELO" NUMBER(4,0), 
	...
	"DESCRIPCION" VARCHAR2(1000), 
	 CONSTRAINT "MODELO_PK" PRIMARY KEY ("ID_MODELO") ENABLE
   )
/
...
CREATE TABLE  "EVEN_PROC_CONT" 
   (	"TIPO_EVENTO" VARCHAR2(100), 
	"PROC_CONT" VARCHAR2(100), 
	 CONSTRAINT "EVENTOS_PROC_CONT_PK" PRIMARY KEY ("TIPO_EVENTO", "PROC_CONT") ENABLE
   )
/
CREATE TABLE  "EVENTOS_CONTRATACION" 
   (	"EVENTO" NUMBER(6,0), 
	...
	"FECHA_ESPERADA_FIN" TIMESTAMP (6) NOT NULL ENABLE, 
...
CREATE TABLE  "EXPEDIENTE_GASTO" 
   (	"ID_EXP_GASTO" NUMBER(6,0), 
	...
	"EXP_GASTO" VARCHAR2(20) NOT NULL ENABLE, 
	 CONSTRAINT "EXPEDIENTE_GASTO_PK" PRIMARY KEY ("ID_EXP_GASTO") ENABLE
   )
/
...
CREATE TABLE  "INGRESOS" 
   (	"ID_INGRESO" NUMBER(4,0), 
	"IMPORTE" NUMBER(10,2) NOT NULL ENABLE, 
	"FECHA_INICIO_LIQUIDACION" TIMESTAMP (6) NOT NULL ENABLE, 
	"FECHA_FIN_LIQUIDACION" TIMESTAMP (6) NOT NULL ENABLE, 
	"DESCRIPCION" VARCHAR2(100) NOT NULL ENABLE, 
	"DOCUMENTO" BLOB, 
	"FECHA_ENVIO" TIMESTAMP (6), 
...
CREATE TABLE  "TIPOS_DOCUMENTO_FACTURACION" 
   (	"TIPO_DOCUMENTO_FACTURACION" VARCHAR2(15), 
	"DESCRIPCION" VARCHAR2(200) NOT NULL ENABLE, 
	 CONSTRAINT "TIPOS_DOCUMENTO_FACT_PK" PRIMARY KEY ("TIPO_DOCUMENTO_FACTURACION") ENABLE
   )
/
...
/
ALTER TABLE  "EVEN_PROC_CONT" ADD CONSTRAINT "EVEN_PROC_CONT_TIPO_FK" FOREIGN KEY ("TIPO_EVENTO")
	  REFERENCES  "TIPOS_EVENTO_CONTRATACION" ("TIPO_EVENTO") ENABLE
/
...
ALTER TABLE  "EXPEDIENTE_GASTO" ADD CONSTRAINT "EXPEDIENTE_GASTO_FK" FOREIGN KEY ("UA", "NUM_LOTE")
	  REFERENCES  "LOTES" ("UA", "NUM_LOTE") ENABLE
/
ALTER TABLE  "FACTURAS" ADD CONSTRAINT "FACTURA_PAGADOR_FK" FOREIGN KEY ("PAGADOR")
...
ALTER TABLE  "LINEAS_FACTURA" ADD CONSTRAINT "LINEAS_FACTURA_FACT_FK" FOREIGN KEY ("NUM_FACTURA")
	  REFERENCES  "FACTURAS" ("ID_FACTURA") ENABLE
/
ALTER TABLE  "LOTES" ADD CONSTRAINT "LOTES_EXP_PK" FOREIGN KEY ("UA")
	  REFERENCES  "EXPEDIENTES" ("UA") ENABLE
/
...
ALTER TABLE  "LOTES" ADD CONSTRAINT "LOTES_TRAMITADOR_FK" FOREIGN KEY ("ID_TRAMITADOR")
	  REFERENCES  "TRAMITADORES" ("ID_TRAMITADOR") ENABLE
/
ALTER TABLE  "MODELOS" ADD CONSTRAINT "MODELO_FK" FOREIGN KEY ("TIPO_MODELO")
...
/
 ...
 CREATE SEQUENCE   "PRUEBA_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE
/
...
/
 CREATE SEQUENCE   "PREVISIONES_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 21 CACHE 20 NOORDER  NOCYCLE
/
...
/
 CREATE SEQUENCE   "NUM_IMPUTACIONES_LOTE_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 NOCACHE  NOORDER  NOCYCLE
/
 CREATE SEQUENCE   "MODIFICACIONES_PRESUPUESTO_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 21 CACHE 20 NOORDER  NOCYCLE
/
 CREATE SEQUENCE   "MODELO_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 21 CACHE 20 NOORDER  NOCYCLE
/
...
/
 CREATE SEQUENCE   "INGRESOS_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 21 CACHE 20 NOORDER  NOCYCLE
/
...
/
 CREATE SEQUENCE   "GENERADORES_INGRESO_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 21 CACHE 20 NOORDER  NOCYCLE
/
 CREATE SEQUENCE   "FACTURA_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE
/
 CREATE SEQUENCE   "EXPEDIENTES_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 21 CACHE 20 NOORDER  NOCYCLE
/
 CREATE SEQUENCE   "EXPEDIENTE_GASTO_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE
/
...
/
CREATE OR REPLACE TRIGGER  "BI_MODELO" 
...
/
CREATE OR REPLACE TRIGGER  "BI_FACTURA" 
...
/
CREATE OR REPLACE TRIGGER  "BI_EXPEDIENTE_GASTO" 
