...
CREATE TABLE  "RESERVAS_CAJAFIJA" 
   (	"SECCION" VARCHAR2(4), 
	...
	"IMPORTE" NUMBER(2,8) NOT NULL ENABLE, 
	"UDSGAF" VARCHAR2(15), 
...
CREATE TABLE  "IMPUTACIONES_PREVISION" 
   (	"SP" NUMBER(6,0), 
	...
	"IMPORTE_LIC" NUMBER(2,8), 
	 CONSTRAINT "IMPUTACIONES_PREVISION_PK" PRIMARY KEY ("SP", "SECCION", "SERVICIO", "PROGRAMA", "CONCEPTO", "ANO") ENABLE
   )
/
...
CREATE TABLE  "INGRESOS" 
   (	"ID_INGRESO" NUMBER(4,0), 
	"IMPORTE" NUMBER(2,4) NOT NULL ENABLE, 
...
CREATE TABLE  "PAGADORES" 
   (	"ID_PAGADOR" VARCHAR2(20), 
	...
	"DATOS_PAGADOR" VARCHAR2(200), 
	 CONSTRAINT "PAGADORES_PK" PRIMARY KEY ("ID_PAGADOR") ENABLE
   )
/
CREATE TABLE  "PAGOS" 
   (	"ID_PAGO" NUMBER(4,0), 
...
/
 CREATE SEQUENCE   "MODIFICACIONES_PRESUPUESTO_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE
/
 CREATE SEQUENCE   "MODELO_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE
/
